...
var $b4bf5337efa08e7c$exports = {};

(parcelRequire("aKzDW")).register(new URL("", import.meta.url).toString(), JSON.parse("[\"1z9yS\",\"index.dfdf26dd.js\",\"5BOVG\",\"icons.e4634d3e.svg\"]"));

'use strict';
'use strict';
var $739714331996ab95$exports = {};
'use strict';
var $cff4596c5de92f30$exports = {};
'use strict';
var $cff4596c5de92f30$var$check = function(it) {
    return it && it.Math === Math && it;
};
// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
$cff4596c5de92f30$exports = // eslint-disable-next-line es/no-global-this -- safe
$cff4596c5de92f30$var$check(typeof globalThis == 'object' && globalThis) || $cff4596c5de92f30$var$check(typeof window == 'object' && window) || // eslint-disable-next-line no-restricted-globals -- safe
$cff4596c5de92f30$var$check(typeof self == 'object' && self) || $cff4596c5de92f30$var$check(typeof $parcel$global == 'object' && $parcel$global) || $cff4596c5de92f30$var$check(typeof $cff4596c5de92f30$exports == 'object' && $cff4596c5de92f30$exports) || // eslint-disable-next-line no-new-func -- fallback
function() {
    return this;
...
$c52f4aba42d917bb$exports = function(namespace, method) {
    return arguments.length < 2 ? $c52f4aba42d917bb$var$aFunction($cff4596c5de92f30$exports[namespace]) : $cff4596c5de92f30$exports[namespace] && $cff4596c5de92f30$exports[namespace][method];
};
...
'use strict';
var $7e843cd4bb38e8da$exports = {};
'use strict';

var $0e3acfdad29bed32$exports = {};
'use strict';

var $0e3acfdad29bed32$var$navigator = $cff4596c5de92f30$exports.navigator;
var $0e3acfdad29bed32$var$userAgent = $0e3acfdad29bed32$var$navigator && $0e3acfdad29bed32$var$navigator.userAgent;
$0e3acfdad29bed32$exports = $0e3acfdad29bed32$var$userAgent ? String($0e3acfdad29bed32$var$userAgent) : '';


var $7e843cd4bb38e8da$var$process = $cff4596c5de92f30$exports.process;
var $7e843cd4bb38e8da$var$Deno = $cff4596c5de92f30$exports.Deno;
var $7e843cd4bb38e8da$var$versions = $7e843cd4bb38e8da$var$process && $7e843cd4bb38e8da$var$process.versions || $7e843cd4bb38e8da$var$Deno && $7e843cd4bb38e8da$var$Deno.version;
var $7e843cd4bb38e8da$var$v8 = $7e843cd4bb38e8da$var$versions && $7e843cd4bb38e8da$var$versions.v8;
var $7e843cd4bb38e8da$var$match, $7e843cd4bb38e8da$var$version;
if ($7e843cd4bb38e8da$var$v8) {
    $7e843cd4bb38e8da$var$match = $7e843cd4bb38e8da$var$v8.split('.');
    // in old Chrome, versions of V8 isn't V8 = Chrome / 10
    // but their correct versions are not interesting for us
    $7e843cd4bb38e8da$var$version = $7e843cd4bb38e8da$var$match[0] > 0 && $7e843cd4bb38e8da$var$match[0] < 4 ? 1 : +($7e843cd4bb38e8da$var$match[0] + $7e843cd4bb38e8da$var$match[1]);
}
// BrowserFS NodeJS `process` polyfill incorrectly set `.v8` to `0.0`
// so check `userAgent` even if `.v8` exists, but 0
if (!$7e843cd4bb38e8da$var$version && $0e3acfdad29bed32$exports) {
    $7e843cd4bb38e8da$var$match = $0e3acfdad29bed32$exports.match(/Edge\/(\d+)/);
    if (!$7e843cd4bb38e8da$var$match || $7e843cd4bb38e8da$var$match[1] >= 74) {
        $7e843cd4bb38e8da$var$match = $0e3acfdad29bed32$exports.match(/Chrome\/(\d+)/);
        if ($7e843cd4bb38e8da$var$match) $7e843cd4bb38e8da$var$version = +$7e843cd4bb38e8da$var$match[1];
    }
}
$7e843cd4bb38e8da$exports = $7e843cd4bb38e8da$var$version;




var $544d77b8dc8b6a35$var$$String = $cff4596c5de92f30$exports.String;
...
$544d77b8dc8b6a35$exports = !!Object.getOwnPropertySymbols && !$b65563e7fd9a9951$exports(function() {
    ...
    !Symbol.sham && $7e843cd4bb38e8da$exports && $7e843cd4bb38e8da$exports < 41;
});
...
$835fb6c3976fe66a$exports = function(key, value) {
    try {
        $835fb6c3976fe66a$var$defineProperty($cff4596c5de92f30$exports, key, {
            value: value,
            configurable: true,
            writable: true
        });
    } catch (error) {
        $cff4596c5de92f30$exports[key] = value;
    }
    return value;
};
...
var $81b5f45e59d3fa0d$var$store = $81b5f45e59d3fa0d$exports = $cff4596c5de92f30$exports[$81b5f45e59d3fa0d$var$SHARED] || $835fb6c3976fe66a$exports($81b5f45e59d3fa0d$var$SHARED, {});
...
var $db48b9fc13f8cfc2$var$Symbol = $cff4596c5de92f30$exports.Symbol;
...
var $6ad98e3f9c7d8cc0$var$document = $cff4596c5de92f30$exports.document;
...
var $6f423c90ad9fbe42$var$WeakMap = $cff4596c5de92f30$exports.WeakMap;
...
var $67c1f2c2b0121f47$var$TypeError = $cff4596c5de92f30$exports.TypeError;
var $67c1f2c2b0121f47$var$WeakMap = $cff4596c5de92f30$exports.WeakMap;
...
*/ $739714331996ab95$exports = function(options, source) {
    ...
    if (GLOBAL) target = $cff4596c5de92f30$exports;
    else if (STATIC) target = $cff4596c5de92f30$exports[TARGET] || $835fb6c3976fe66a$exports(TARGET, {});
    else target = $cff4596c5de92f30$exports[TARGET] && $cff4596c5de92f30$exports[TARGET].prototype;
...
var $40778e22ccaf12bb$exports = {};
'use strict';

// eslint-disable-next-line redos/no-vulnerable -- safe
$40778e22ccaf12bb$exports = /(?:ipad|iphone|ipod).*applewebkit/i.test($0e3acfdad29bed32$exports);


var $f0594b8006cb3a05$exports = {};
'use strict';
var $16fb3375fd72fe90$exports = {};
'use strict';



var $16fb3375fd72fe90$var$userAgentStartsWith = function(string) {
    return $0e3acfdad29bed32$exports.slice(0, string.length) === string;
};
$16fb3375fd72fe90$exports = function() {
    if ($16fb3375fd72fe90$var$userAgentStartsWith('Bun/')) return 'BUN';
    if ($16fb3375fd72fe90$var$userAgentStartsWith('Cloudflare-Workers')) return 'CLOUDFLARE';
    if ($16fb3375fd72fe90$var$userAgentStartsWith('Deno/')) return 'DENO';
    if ($16fb3375fd72fe90$var$userAgentStartsWith('Node.js/')) return 'NODE';
    if ($cff4596c5de92f30$exports.Bun && typeof Bun.version == 'string') return 'BUN';
    if ($cff4596c5de92f30$exports.Deno && typeof Deno.version == 'object') return 'DENO';
    if ($ed6e0112c97f8b4e$exports($cff4596c5de92f30$exports.process) === 'process') return 'NODE';
    if ($cff4596c5de92f30$exports.window && $cff4596c5de92f30$exports.document) return 'BROWSER';
    return 'REST';
}();


$f0594b8006cb3a05$exports = $16fb3375fd72fe90$exports === 'NODE';


var $2558ebfc80919dbf$var$set = $cff4596c5de92f30$exports.setImmediate;
var $2558ebfc80919dbf$var$clear = $cff4596c5de92f30$exports.clearImmediate;
var $2558ebfc80919dbf$var$process = $cff4596c5de92f30$exports.process;
var $2558ebfc80919dbf$var$Dispatch = $cff4596c5de92f30$exports.Dispatch;
var $2558ebfc80919dbf$var$Function = $cff4596c5de92f30$exports.Function;
var $2558ebfc80919dbf$var$MessageChannel = $cff4596c5de92f30$exports.MessageChannel;
var $2558ebfc80919dbf$var$String = $cff4596c5de92f30$exports.String;
...
$b65563e7fd9a9951$exports(function() {
    ...
    $2558ebfc80919dbf$var$$location = $cff4596c5de92f30$exports.location;
});
...
var $2558ebfc80919dbf$var$globalPostMessageDefer = function(id) {
    ...
    $cff4596c5de92f30$exports.postMessage($2558ebfc80919dbf$var$String(id), $2558ebfc80919dbf$var$$location.protocol + '//' + $2558ebfc80919dbf$var$$location.host);
};
...
if (!$2558ebfc80919dbf$var$set || !$2558ebfc80919dbf$var$clear) {
    ...
    // Node.js 0.8-
    if ($f0594b8006cb3a05$exports) $2558ebfc80919dbf$var$defer = function(id) {
    ...
    else if ($2558ebfc80919dbf$var$MessageChannel && !$40778e22ccaf12bb$exports) {
    ...
    } else if ($cff4596c5de92f30$exports.addEventListener && $453ccaf7659e4906$exports($cff4596c5de92f30$exports.postMessage) && !$cff4596c5de92f30$exports.importScripts && $2558ebfc80919dbf$var$$location && $2558ebfc80919dbf$var$$location.protocol !== 'file:' && !$b65563e7fd9a9951$exports($2558ebfc80919dbf$var$globalPostMessageDefer)) {
        $2558ebfc80919dbf$var$defer = $2558ebfc80919dbf$var$globalPostMessageDefer;
        $cff4596c5de92f30$exports.addEventListener('message', $2558ebfc80919dbf$var$eventListener, false);
    // IE8-
...
$739714331996ab95$exports({
    ...
    bind: true,
    enumerable: true,
    forced: $cff4596c5de92f30$exports.clearImmediate !== $a8004ceb65088a68$require$clearImmediate
}, {
...
var $f3b074559d8266c5$var$Function = $cff4596c5de92f30$exports.Function;
// dirty IE9- and Bun 0.3.0- checks
var $f3b074559d8266c5$var$WRAP = /MSIE .\./.test($0e3acfdad29bed32$exports) || $16fb3375fd72fe90$exports === 'BUN' && function() {
    var version = $cff4596c5de92f30$exports.Bun.version.split('.');
...
// https://github.com/oven-sh/bun/issues/1633
var $987cf72b0c906cb1$var$setImmediate = $cff4596c5de92f30$exports.setImmediate ? $f3b074559d8266c5$exports($987cf72b0c906cb1$require$setTask, false) : $987cf72b0c906cb1$require$setTask;
// `setImmediate` method
...
$739714331996ab95$exports({
    ...
    bind: true,
    enumerable: true,
    forced: $cff4596c5de92f30$exports.setImmediate !== $987cf72b0c906cb1$var$setImmediate
}, {
...
const $949cefe0e606d775$export$923ea8233b386e99 = 'https://forkify-api.jonas.io/api/v2/recipes/';
const $949cefe0e606d775$export$196440f71ed9f601 = 10;
const $949cefe0e606d775$export$5feaddb1377b7f5e = 12;
const $949cefe0e606d775$export$7167c830cefcb6b5 = 'e3a66c93-f533-4f95-aab3-3d771dd34574';
...
const $f821677b80d93c23$export$5e23f4642ecad5ea = function(newServings) {
    $f821677b80d93c23$export$ca000e230c0caa3e.recipe.ingredients.forEach((ing)=>{
        ing.quantity = ing.quantity * newServings / $f821677b80d93c23$export$ca000e230c0caa3e.recipe.servings;
...
const $f821677b80d93c23$export$72009cc673d27d80 = function(recipe) {
    ...
    if (recipe.id === $f821677b80d93c23$export$ca000e230c0caa3e.recipe.id) $f821677b80d93c23$export$ca000e230c0caa3e.recipe.bookmarked = true;
    $f821677b80d93c23$var$persistBookmarks();
};
const $f821677b80d93c23$export$136048bcb9946c75 = function(id) {
    // Delete bookmark
    const index = $f821677b80d93c23$export$ca000e230c0caa3e.bookmarks.findIndex((el)=>el.id === id);
    $f821677b80d93c23$export$ca000e230c0caa3e.bookmarks.splice(index, 1);
    // Mark current recipe as NOT bookmarked
    if (id === $f821677b80d93c23$export$ca000e230c0caa3e.recipe.id) $f821677b80d93c23$export$ca000e230c0caa3e.recipe.bookmarked = false;
    $f821677b80d93c23$var$persistBookmarks();
};
...
const $f821677b80d93c23$var$clearBookmarks = function() {
...
var $b6cdd1a034d597c2$exports = {};
$b6cdd1a034d597c2$exports = new URL("icons.e4634d3e.svg", import.meta.url).toString();
...
class $39aeb40ef9a540e0$export$2e2bcd8739ae039 {
   ...
   */ render(data, render = true) {
    ...
    renderSpinner() {
       ...
       <div class="spinner">
              <svg>
                <use href="${(0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports)))}#icon-loader"></use>
              </svg>
       </div> 
      `;
        this._clear();
    ...
    renderError(message = this._errorMessage) {
        const markup = `
          <div class="error">
                <div>
                  <svg>
                    <use href="${(0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports)))}#icon-alert-triangle"></use>
                  </svg>
                </div>
                <p>${message}</p>
              </div>
    ...
    renderMessage(message = this._message) {
        const markup = `
          <div class="message">
                <div>
                  <svg>
                    <use href="${(0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports)))}#icon-smile"></use>
                  </svg>
                </div>
                <p>${message}</p>
              </div>
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-users"></use>
            </svg>
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--update-servings" data-update-to="${this._data.servings - 1}">
                <svg>
                  <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-minus-circle"></use>
                </svg>
              </button>
              <button class="btn--tiny btn--update-servings" data-update-to="${this._data.servings + 1}">
                <svg>
                  <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-plus-circle"></use>
                </svg>
              </button>
            </div>
          </div>
          ...
          <div class="recipe__user-generated ${this._data.key ? '' : 'hidden'}">
            <svg>
              <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-user"></use>
            </svg>
          </div>
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-bookmark${this._data.bookmarked ? '-fill' : ''}"></use>
            </svg>
          </button>
        </div>
        ...
        <div class="recipe__directions">
          ...
          >
            ...
            <svg class="search__icon">
              <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-arrow-right"></use>
            </svg>
          </a>
        </div>
    `;
        ...
        return `
            <li class="recipe__ingredient">
              <svg class="recipe__icon">
                <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}#icon-check"></use>
              </svg>
...
class $14d5a89801d55f2c$var$PreviewView extends (0, $39aeb40ef9a540e0$export$2e2bcd8739ae039) {
    _parentElement = '';
    _generateMarkup() {
...
class $3b3a807ebcd3404d$var$ResultsView extends (0, $39aeb40ef9a540e0$export$2e2bcd8739ae039) {
    ...
    _generateMarkup() {
      ...
      `;
        ...
        <button data-goto="${curPage - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
              <use href="${0, (/*@__PURE__*/$parcel$interopDefault($b6cdd1a034d597c2$exports))}}#icon-arrow-left"></use>
            </svg>
            <span>Page ${curPage - 1}</span>
          </button>
...
class $5346de1ad3f80d2d$var$BookmarksView extends (0, $39aeb40ef9a540e0$export$2e2bcd8739ae039) {
...
class $3a43958ee387c94d$var$AddRecipeView extends (0, $39aeb40ef9a540e0$export$2e2bcd8739ae039) {
...
const $51e55805949f51d8$var$controlSearchResults = async function() {
    try {
        ...
        (0, $3b3a807ebcd3404d$export$2e2bcd8739ae039).render($f821677b80d93c23$export$8d7f79465139ab72());
...
const $51e55805949f51d8$var$controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, $87c8fee486b3a62a$export$2e2bcd8739ae039).render($f821677b80d93c23$export$ca000e230c0caa3e.recipe);
        // Sucess message
        (0, $3a43958ee387c94d$export$2e2bcd8739ae039).renderMessage();
        ...
        // Close form window
        setTimeout(function() {
            (0, $3a43958ee387c94d$export$2e2bcd8739ae039).toggleWindow();
...
//# sourceMappingURL=index.dfdf26dd.js.map
